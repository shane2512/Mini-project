...
async function loadInvoices(){
    const{data}=await db.from('invoices').select('*,customers(name)').order('invoice_id',{ascending:false});
    allInvoices=data||[];
