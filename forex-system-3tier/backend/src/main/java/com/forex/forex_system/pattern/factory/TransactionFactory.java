...
public class TransactionFactory {
    public static ForexTransaction createTransaction(Long customerId, Long bankId, String fromCurrency, String toCurrency, Long fromBankId, Long toBankId, Double amount, Double convertedAmount, Double rate) {
